...
//        }
    ...
    public void showSongs(JPanel songPanel) {
        searchAndBackGroundPanel.remove(scrollPane2);
//        scrollPane2 = new JScrollPane(songPanel, ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS, ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
//        searchAndBackGroundPanel.add(scrollPane2, BorderLayout.CENTER);
        //        searchAndBackGroundPanel.add(scrollPane2, BorderLayout.CENTER);
    }
}
